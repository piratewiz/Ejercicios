...
for (const user of users) {
  if (user.years >= 18) {
    personasMayores.push(user.name)
  }
  if (user.years < 18) {
    personasMenores.push(user.name)
  }
}
console.log('Usuarios mayores de edad:', personasMayores)
console.log('Usuarios menores de edad:', personasMenores)
